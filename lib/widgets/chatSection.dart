...
class ChatingSection extends StatelessWidget {
  final String senderProfile = 'assets/images/avatars/a3.jpg';
  final String receiverProfile = 'assets/images/avatars/a6.jpg';
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const ImageMessage(
              image: 'assets/images/avatars/a1.jpg',
              date: "17:09",
          ...
          Expanded(
            child: Container(
              ...
              child: Text(
                message,
                style: GoogleFonts.inter(
                  color: isReceiver == 1 ? vert : Colors.white,
                  fontSize: 12,
                  fontWeight: FontWeight.w500,
                ),
              ),
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Image.asset(
                  'assets/images/avatars/sound-waves.png',
                  height: 35,
                  width: 130,
                  fit: BoxFit.fill,
                ),
